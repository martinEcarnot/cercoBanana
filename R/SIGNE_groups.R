...
source('~/Documents/INRA/R/adj_asd.R')
source('~/Documents/INRA/Projets/SIGNE/2017/SIGNE_load.R')
source('~/Documents/INRA/Projets/SIGNE/2017/SIGNE_maha.R')
source('~/Documents/INRA/Projets/SIGNE/2017/SIGNE_maha0.R')
...
iok=substr(rownames(globalmatrix),1,5) %in% dates
...
class=as.factor(substr(rownames(sp),7,9))
